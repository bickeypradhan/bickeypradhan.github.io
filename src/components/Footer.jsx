    ...
    <div className="mt-32 pb-8 flex flex-col items-center relative z-10">
      ...
      <div className="w-full flex flex-col md:flex-row items-center md:justify-between gap-6">
        ...
        <div className="flex gap-3 order-2 md:order-none">
          <a href={personalInfo.github} target="_blank" rel="noreferrer"><i className="ri-github-fill ri-2x"></i></a>
          <a href={personalInfo.linkedin} target="_blank" rel="noreferrer"><i className="ri-linkedin-box-fill ri-2x"></i></a>
          <a href={`mailto:${personalInfo.email}`}><i className="ri-mail-fill ri-2x"></i></a>
        </div>
